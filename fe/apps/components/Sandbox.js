  ...
  return (
    ...
    >
      <ScrollView>
        ...
        <View
          style={{ backgroundColor: "yellow", height: 400, width: "100%" }} /> */}
          <Image source={{uri:'https://picsum.photos/id/1/200/300'}} style={{height:500, width:500}} resizeMode="contain" />
          <Image source={{uri:'https://picsum.photos/id/2/200/300'}} style={{height:500, width:500}} resizeMode="contain" />
          <Image source={{uri:'https://picsum.photos/id/3/200/300'}} style={{height:500, width:500}} resizeMode="contain" />
          <Image source={{uri:'https://picsum.photos/id/4/200/300'}} style={{height:500, width:500}} resizeMode="contain" />
